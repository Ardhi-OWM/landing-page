    ...
    <>
      <div className="flex justify-center p-3">
        <input
          ...
          className="w-full max-w-md px-4 py-2 border rounded shadow tagline"
          value={searchQuery}
      ...
      {contentToDisplay.map((item) => (
          <div id={item.id} key={item.id}
            className='w-[calc(50%-0.5rem)] md:w-[28rem] bg-n-8 border-b border-n-6 rounded-[1rem] px-4 py-4 mb-4 hover:bg-n-7 hover:shadow-lg transition duration-300 ease-in-out'>
